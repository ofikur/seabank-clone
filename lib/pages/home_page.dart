            ...
            Expanded(
              child: ListView(
                children: const [
                  ...
                  MainMenu(),
                  InfoBanner(),
                  PromoBanner(imagePath: 'assets/images/banner_promo_1.png'),
                  FlashDeals(),
                  SizedBox(height: 7.0),
                  PromoBanner(height: 120, imagePath: 'assets/images/banner_promo_2.png'),
                  ConnectedEwallet(),
                  TransactionHistory(),
                  SizedBox(height: 7.0),
                  PromoBanner(height: 120, imagePath: 'assets/images/banner_promo_3.png'),
                  RecentTranfers(),
                  SizedBox(height: 14),
                ],
              ),
